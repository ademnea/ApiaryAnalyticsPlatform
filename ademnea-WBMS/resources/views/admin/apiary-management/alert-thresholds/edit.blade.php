...
@section('title', 'Edit Alert Threshold')
@section('page-title', 'Edit Alert Threshold')
@section('breadcrumbs')
...
<div class="card">
    ...
    <div class="card-body">
        <form method="POST" action="{{ route('admin.alert-thresholds.update', ['alertThreshold' => $threshold]) }}">
            @csrf
            @method('PUT')
